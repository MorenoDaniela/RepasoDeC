...
{
    strcpy(arrayOrquesta[0].nombre,"UnderMySkin");
    strcpy(arrayOrquesta[0].lugar,"Ontario 456");
    arrayOrquesta[0].isEmpty=0;
    arrayOrquesta[0].idOrquesta=1;
    arrayOrquesta[0].tipo=1;

    strcpy(arrayOrquesta[1].nombre,"Blink");
    strcpy(arrayOrquesta[1].lugar,"California 182");
    arrayOrquesta[1].isEmpty=0;
    arrayOrquesta[1].idOrquesta=3;
    arrayOrquesta[1].tipo=3;

    strcpy(arrayOrquesta[2].nombre,"Nigthmare");
    strcpy(arrayOrquesta[2].lugar,"Halsey 2019");
    arrayOrquesta[2].isEmpty=0;
    arrayOrquesta[2].idOrquesta=5;
    arrayOrquesta[2].tipo=2;

    strcpy(arrayOrquesta[3].nombre,"Habanna");
    strcpy(arrayOrquesta[3].lugar,"Cuba 1234");
    arrayOrquesta[3].isEmpty=0;
    arrayOrquesta[3].idOrquesta=6;
